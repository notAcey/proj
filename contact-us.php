...
if (isset($_POST['send'])) {
    ...
    if($lastInsertId)
    {
        ...
        try {
            // Configurare server
            $mail->isSMTP();
            $mail->Host = 'smtp.gmail.com'; // Setează adresa serverului SMTP
            $mail->SMTPAuth = true;
            $mail->Username = 'your-email@gmail.com'; // Adresa de email SMTP
            $mail->Password = 'your-email-password'; // Parola SMTP
            ...
            // Conținut email
            $mail->isHTML(true);
            $mail->Subject = 'Your Message to RideWave';
            $mail->Body = "<p>Full Name: $name</p><p>Email Address: $email</p><p>Phone Number: $contactno</p><p>Message: $message</p>";
...
<!-- Fav and touch icons -->
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/images/favicon-icon/favicon_115.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="assets/images/favicon-icon/apple-touch-icon-114-precomposed.html">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="assets/images/favicon-icon/favicon_75.png">
<link rel="apple-touch-icon-precomposed" href="assets/images/favicon-icon/favicon_60.png">
